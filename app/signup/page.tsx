    ...
    >
      <div style={{ width: '100%', maxWidth: 400 }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h1 data-testid="signup-heading" style={{ fontSize: 24, fontWeight: 700, color: '#111827', margin: 0 }}>Create your account</h1>
          <p style={{ fontSize: 14, color: '#6B7280', marginTop: 6 }}>Join Patch — Discount Tire IT Support</p>
        </div>
        ...
        <div style={{ background: '#fff', border: '1px solid #E5E7EB', borderRadius: 14, padding: '28px 28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
          ...
          <form onSubmit={handleSubmit} data-testid="signup-form">
            <div style={{ marginBottom: 16 }}>
              <label data-testid="username-label" style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#374151', marginBottom: 6 }}>
                Username
              </label>
              <input
          ...
          <p style={{ textAlign: 'center', marginTop: 18, fontSize: 13, color: '#6B7280' }}>
            ...
            <Link data-testid="login-link" href="/login" style={{ color: '#DC2626', fontWeight: 600, textDecoration: 'none' }}>
              Login
            </Link>
          </p>
        </div>
